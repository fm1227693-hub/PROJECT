...
export default function StudentsPage() {
  return (
    <AudiencePage
      ...
      related={[
        { title: "Mathematics diagnostic", href: "/diagnostic/math", body: "Twelve measured skills across arithmetic, algebra and geometry." },
        { title: "English diagnostic", href: "/diagnostic/english", body: "Grammar, vocabulary, reading and listening — reported separately." },
