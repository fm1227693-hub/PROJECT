...
// Dynamic import for R3F Canvas (no SSR) — production-grade
...
export default function Page() {
  ...
  const footerRingRef = useRef<HTMLDivElement>(null)
  ...
  // Footer ring — Phase 4 coalesce into glowing loop anchoring near footer
  useEffect(() => {
  ...
  return (
    <main className="relative bg-[#050508] text-white selection:bg-[#7a2bff] overflow-x-hidden">
      <LiquidCursor />
      <Header />
            ...
            <div className="flex flex-col lg:flex-row justify-between gap-12 items-end">
              ...
              <div className="lg:max-w-[420px] pb-4">
                <p className="text-[15px] leading-[1.6] text-white/60">
                  ...
                  intensity 1.25, luminance threshold 0.85. Micro film grain 0.04 eliminates 8-bit banding.
                </p>
