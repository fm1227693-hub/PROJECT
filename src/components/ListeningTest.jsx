...
export default function ListeningTest({ onExit }) {
  ...
  const parts = [
      ...
      questions: (
        <div className="space-y-10 pb-20">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-black mb-2">Part 1</h2>
    ...
    },
    {
      ...
      questions: (
        <div className="space-y-10 pb-20">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-black mb-2">Part 2</h2>
    ...
    },
    {
      ...
      questions: (
        <div className="space-y-10 pb-20">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-black mb-2">Part 3</h2>
    ...
    },
    {
      ...
      questions: (
        <div className="space-y-10 pb-20">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-black mb-2">Part 4</h2>
