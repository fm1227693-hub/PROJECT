            ...
            >
                ...
                <div className="w-full lg:w-1/2 flex justify-center items-end relative z-10 self-end pt-2 lg:pt-3 overflow-hidden">
                    ...
                    <div className="relative w-[310px] xs:w-[335px] sm:w-[365px] bg-[#141a29] border border-slate-700/80 rounded-t-[48px] rounded-b-none p-[4px] pb-0 shadow-[0_25px_60px_rgba(0,0,0,0.8)] select-none translate-y-5 sm:translate-y-6 lg:translate-y-7">
                        ...
                        <div className="w-full h-full bg-black rounded-t-[44px] rounded-b-none p-[2px] pb-0 relative overflow-hidden flex flex-col justify-between">

                            {/* True Apple Dynamic Island Pill */}
                            <div className="absolute top-2.5 left-1/2 -translate-x-1/2 w-[106px] h-[28px] bg-black rounded-full z-40 flex items-center justify-between px-2.5 border border-black shadow-sm">
                                {/* Left FaceID Sensor Pill */}
                                <div className="w-[38px] h-[13px] rounded-full bg-[#0c0c10] border border-[#14141a]" />

                                {/* Right Camera Lens with Purple/Blue Glass Glare Ring */}
                                <div className="w-[15px] h-[15px] rounded-full bg-[#08080c] border border-[#1a1d28] flex items-center justify-center relative">
                                    <div className="w-[8px] h-[8px] rounded-full bg-[#182036] border border-[#273559] flex items-center justify-center">
                                        <div className="w-[2.5px] h-[2.5px] rounded-full bg-[#3b82f6] opacity-90 shadow-[0_0_2px_#3b82f6]" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="w-full bg-[#faf7f5] rounded-t-[42px] rounded-b-[36px] pt-2.5 px-3.5 pb-4 font-sans text-slate-900 relative">
                                ...
                                <div className="flex items-center justify-between px-1.5 pt-0.5 pb-1 text-slate-900 font-sans">
                                    ...
                                    <div className="flex items-center gap-1.5 pr-1 text-slate-900">
                                        ...
                                        <svg className="w-4 h-3 text-slate-900 shrink-0" viewBox="0 0 17 12" fill="currentColor">
                                        ...
                                        <svg className="w-4 h-3 text-slate-900 shrink-0" viewBox="0 0 16 12" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round">
                                        ...
                                        <div className="flex items-center shrink-0">
                                            <div className="w-[21px] h-[11px] border-[1.4px] border-slate-900 rounded-[4px] p-[1.2px] flex items-center relative">
                                                <div className="w-full h-full bg-slate-900 rounded-[1.8px]" />
                                            </div>
                                            <div className="w-[1.8px] h-[3.5px] bg-slate-900 rounded-r-[1px] -ml-[0.5px]" />
                                        </div>
                                    </div>
                                </div>

                                {/* Mentor App Header Row */}
                                <div className="flex items-center justify-between py-2 px-0.5 mt-1">
                                    <div className="flex items-center gap-2">
                                        {/* Brand Red Mint Icon */}
                                        <div className="w-10 h-10 rounded-2xl bg-gradient-to-r from-red-600/20 to-rose-600/20 border border-red-500/30 flex items-center justify-center text-red-600 font-black shadow-sm">
                                            <FaChalkboardTeacher className="w-5 h-5 text-red-600" />
                                        </div>
                                        {/* Brand Red Plus Button */}
                                        <Link
                                            to="/about"
                                            className="w-7 h-7 rounded-full bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-500 hover:to-rose-500 text-white flex items-center justify-center text-[12px] cursor-pointer hover:scale-105 transition-all shadow-sm shadow-red-600/30 border border-white/20"
                                    ...
                                    <div className="bg-red-500/10 p-1 rounded-full flex items-center gap-1.5 border border-red-500/20">
                                        <div className="w-7 h-7 rounded-full bg-white flex items-center justify-center text-slate-800 shadow-sm relative">
                                            <FaBell className="w-3.5 h-3.5 text-slate-800" />
                                            <span className="absolute top-1 right-1 w-1.5 h-1.5 bg-red-500 rounded-full" />
                                        </div>
                                        <img
                                            src="/photo_2026-07-23_23-14-12.jpg"
                                            alt="Mentor Ruhillo Asrorov"
                                            className="w-7.5 h-7.5 rounded-full object-cover object-top ring-2 ring-red-500 shadow-sm"
                                        />
                                    </div>
                                </div>

                                {/* Main Account Card -> Ruhillo Asrorov IELTS Score & Experience */}
                                <div className="mt-2 bg-gradient-to-br from-[#f3eae8] to-[#eee2e0] p-4 rounded-[26px] border border-red-500/20 text-slate-900 shadow-sm">
                                    <div className="flex items-center justify-between">
                                        <span className="text-[13px] font-bold text-red-950">Ruhillo Asrorov</span>
                                    </div>
                                    ...
                                    <div className="mt-1 flex items-baseline justify-between">
                                        ...
                                        <button className="px-3.5 py-1.5 bg-gradient-to-r from-red-600 via-rose-600 to-red-700 hover:from-red-500 hover:to-rose-500 text-white text-[12px] font-extrabold rounded-xl flex items-center gap-1.5 shadow-md shadow-red-600/30 transition-transform active:scale-95 border border-white/20">
                                            <FaAward className="w-3.5 h-3.5 text-amber-300" />
                                            <span>Senior</span>
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-4 gap-2 mt-4 mb-1 text-center px-0.5">
                                    <div className="flex flex-col items-center gap-1.5 group cursor-pointer">
                                        <div className="w-13 h-13 sm:w-14 sm:h-14 rounded-full bg-gradient-to-br from-red-600 via-rose-600 to-red-700 group-hover:scale-105 text-white flex items-center justify-center text-lg shadow-md shadow-red-600/30 transition-all border border-white/20">
                                            <FaAward className="w-5 h-5 text-white" />
                                        </div>
                                        <span className="text-[12px] font-bold text-slate-900">IELTS 8.0</span>
                                    </div>
                            ...
                            <div className="h-2.5 bg-black w-full shrink-0" />

                            {/* LOWER FLOATING WHITE CARD */}
                            <div className="w-full bg-[#faf7f5] rounded-t-[36px] rounded-b-none p-4 pt-3.5 shadow-sm flex flex-col justify-between flex-1 pb-4">
                                <div className="flex items-center justify-between mb-3 px-1">
                                    ...
                                    <button
                                        ...
                                        className="px-3.5 py-1 bg-gradient-to-r from-red-600 via-rose-600 to-red-700 hover:from-red-500 hover:to-rose-500 text-white text-[12px] font-extrabold rounded-full cursor-pointer shadow-sm shadow-red-600/30 transition-all active:scale-95 border border-white/20"
                                    >
                                ...
                                {/* 2 Mentor Students */}
                                <div className="space-y-3.5 overflow-y-auto max-h-[140px] scrollbar-none px-1">
                                    ...
                                    <div className="flex items-center justify-between py-1">
                                        <div className="flex items-center gap-3">
                                            <img
                                                ...
                                                alt="Javohir Munirov"
                                                className="w-10 h-10 rounded-full object-cover shrink-0 ring-2 ring-red-500/40 shadow-sm"
                                            />
                                            <div>
                                                <span className="text-[13px] font-extrabold text-slate-900 block leading-tight">Javohir Munirov</span>
                                                <span className="text-[10px] font-medium text-slate-500 block mt-0.5">Listening 9.0 • Reading 7.5</span>
                                            </div>
                                        </div>
                                        <span className="text-[13px] font-black text-red-600 shrink-0 bg-red-500/10 px-2.5 py-1 rounded-xl flex items-center gap-1 border border-red-500/30">
                                    ...
                                    <div className="flex items-center justify-between py-1 border-t border-slate-200/70">
                                        <div className="flex items-center gap-3">
                                            <img
                                            ...
                                            />
                                            <div>
                                                <span className="text-[13px] font-extrabold text-slate-900 block leading-tight">Jahongir Zayniddinov</span>
                                                <span className="text-[10px] font-medium text-slate-500 block mt-0.5">Listening 8.5 • General 7.0</span>
                                            </div>
                                        </div>
                                        <span className="text-[13px] font-black text-red-600 shrink-0 bg-red-500/10 px-2.5 py-1 rounded-xl flex items-center gap-1 border border-red-500/30">
                                            <FaStar className="w-3.5 h-3.5 text-amber-500" />
                                ...
                                {/* Home Bar Indicator */}
                                <div className="w-24 h-[3.5px] bg-slate-900 rounded-full mx-auto mt-3 shrink-0 opacity-90" />
                            </div>
