...
export default function Sec3() {
    ...
    // API manzilini shu yerga yozasiz (Lokal uchun http://localhost:3000/products, 
    // internetdagi real server yoki MockAPI linkini esa deploy qilganda yozasiz)
    ...
    return (
        <div className="max-w-7xl w-full mx-auto px-6 lg:px-8 pt-24 mb-24 select-none font-sans transition-colors duration-200 bg-gray-50 dark:bg-gray-950 min-h-screen">
            ...
            {addModal && <AddComment getdata={GetData} setAddModal={setAddModal} editId={null} />}
            <Toaster />
        </div>
    )
}