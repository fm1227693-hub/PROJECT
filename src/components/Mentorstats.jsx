...
Telefon: +998 ${formData.phone}
    ...
    if (activeMentorDetail) {
        return (
            <div ref={detailTopRef} className="bg-transparent min-h-screen flex flex-col justify-center py-6 pt-[80px] lg:pt-[100px] px-4 md:px-8 text-slate-900 dark:text-white transition-colors">
