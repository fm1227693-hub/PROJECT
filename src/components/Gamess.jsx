...
export default function Gamess() {
  ...
  return (
    <div className={`px-4 font-sans bg-transparent transition-all duration-300 ${activeGame ? 'h-[100dvh] pt-[85px] pb-2 flex flex-col overflow-hidden' : 'min-h-screen pt-24 pb-16'}`}>
