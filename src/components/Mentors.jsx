...
export default function Mentors() {
  return (
    <section className="bg-slate-950 py-16 px-4 md:px-8 text-white">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Kartochkalar grid qismi (Faqat 2 ta o'qituvchini oladi) */}
            ...
            >
              ...
              <div className="flex-1 text-center sm:text-left">
                ...
                <a 
                  ...
                  className="inline-block bg-red-600 hover:bg-red-700 text-white text-sm font-medium px-4 py-2 rounded-xl transition w-full sm:w-auto text-center"
                >
                  Bog'lanish
                </a>
              </div>
