    ...
    return (
        <div className="pt-20 w-full">
            <div className="flex justify-center text-3xl sm:text-5xl mb-6">
                <h1 className="dark:text-white font-extrabold tracking-tight">{t('comments.title')}</h1>
            </div>
                                ...
                                <div className="flex items-center flex-col text-center mb-5 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl shadow-md hover:shadow-xl transition-shadow w-full duration-300 p-4 justify-between">
                                    ...
                                    <div className="flex justify-between gap-x-3 w-full pt-3 border-t border-gray-100 dark:border-gray-800">
                                        <button 
                                            ...
                                            className="px-3 py-1.5 text-xs font-medium border border-rose-300 text-rose-600 rounded-lg hover:bg-rose-50 dark:hover:bg-rose-500/10 transition cursor-pointer"
                                        >
                                        ...
                                        <button 
                                            ...
                                            className="px-3 py-1.5 text-xs font-medium border border-blue-300 text-blue-600 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-500/10 transition cursor-pointer"
                                        >
                                            {t('comments.editBtn')}
                                        </button>
                                    </div>
            ...
            <button
                ...
                className="dark:bg-white bg-gray-900 dark:text-gray-950 text-white w-12 h-12 text-center border rounded-full text-2xl mx-auto mt-5 flex items-center justify-center hover:opacity-95 shadow-md transition cursor-pointer"
