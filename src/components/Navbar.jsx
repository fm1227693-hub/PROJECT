...
export default function Navbar() {
    ...
    return (
        <>
            <div data-navbar-root className={`fixed top-0 left-0 w-full z-50 font-sans select-none pointer-events-none transition-all duration-500 ${scrolled ? 'px-3 sm:px-6 lg:px-8 pt-3 sm:pt-4' : 'px-0 pt-0'} ${navHidden ? '-translate-y-[150%] opacity-0 pointer-events-none' : 'translate-y-0 opacity-100'}`}>
                <motion.header
