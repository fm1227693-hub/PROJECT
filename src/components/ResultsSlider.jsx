...
export default function ResultsSlider() {
    ...
    return (
        <div className="w-full max-w-5xl mx-auto p-6 bg-slate-900 dark:bg-[#090623] border border-slate-800 rounded-3xl shadow-2xl text-white my-10 transition-colors duration-200">
            ...
            <div 
                className={`grid grid-cols-1 md:grid-cols-12 gap-8 items-center bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white p-6 md:p-8 rounded-2xl shadow-inner transition-all duration-300 transform ${
                    isAnimating 
